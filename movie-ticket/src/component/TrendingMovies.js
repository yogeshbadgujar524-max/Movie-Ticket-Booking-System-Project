...
In pre-colonial Karnataka, during the Kadamba dynasty era, the ritual of Bhuta Kola takes root in the culture. Meanwhile, the seeds for the rise of Kaadubettu Shiva are also sown..`,
  ...
  },
  {
    ...
    price: 240,
    category: "Trending",
    image: "https://images.justwatch.com/poster/326047208/s718/sanam-teri-kasam-2.jpg",
    desc: `Two souls once bound by promise are torn apart by fate. Years later, lingering heartache draws them back together — but the wounds still run deep. As they face misunderstandings, memories, and ghosts of the past, they must confront whether love can heal or whether some scars never fade.`,

    director: "Karan Malik",
    writers: "Shruti Agrawal, Rahul Desai",
